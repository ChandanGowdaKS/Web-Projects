...
#page3 {
 ...
 content: "";
  background: url(images/trail6.jpg) no-repeat center center fixed;
  opacity: 20.0;
  top: 0;
  left: 0;
  bottom: 0;
		...
		<article class="col2 pad_left1">
			<div class="container">
				<div class="row">
				  ...
				  <div class="col-sm-9">
				   <p class="account" style="color:white;">Update existing flight details</p>
				   <h3 style="color:white;">Enter the flight number to be updated</h3>
				   ...
				   <a href="" class="button2" style="margin-right:190px;margin-top:17px;margin-bottom:15px" onClick="run();">Confirm</a>
					...
					<div>
						 <p class="button" id="acc_but" onclick="toggle('chartdiv1')">Origin</p>
							 ...
							 <div id="chartdiv3" style="max-width: 83%;display:none">
								<form action="" method="POST">
							 ...
							 <div id="chartdiv4" style="max-width: 83%;display:none">
								<form action="" method="POST">
							 ...
							 <div id="chartdiv5" style="max-width: 83%;display:none">
								<form action="" method="POST">
							 ...
							 <div id="chartdiv6" style="max-width: 83%;display:none">
								<form action="" method="POST">
