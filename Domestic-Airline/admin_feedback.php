		...
		<article class="col2 pad_left1">
			<div class="container">
				<div class="row">
				  ...
				  <div class="col-sm-9">
				   <p class="account" style="color:white;">Feedback of customers</p>
					<div>
						<table style="color:black;width:400px;margin-top:20px; margin-bottom:20px; font-size: 18px;" cellspacing="0">
							<thead>
							 <tr><th>Question</th><th>Very Satisfied</th><th>Satisfied</th><th>Not Satisfied</th></tr>
							</thead><tr style="color:black;background-color:#47478D; padding-top: 30px;">
							<tbody>
							 <tr>
