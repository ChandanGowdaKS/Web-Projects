...
function run(){
	...
	var id = "<?php echo $_GET['id'] ?>";
		...
		e = document.getElementById("kim10");
		var v8=""; 
		...
		e = document.getElementById("kim14");
		var v12=""; 
		...
		e = document.getElementById("kim18");
		var v16="";
		...
		e = document.getElementById("kim22");
		var v20=""; 
		...
		if(v5 && v6 && v7){
			v8 = e.options[e.selectedIndex].value;
			count++;
		}
		if(v9 && v10 && v11){
			v12 = e.options[e.selectedIndex].value;
			count++;
		}
		if(v13 && v14 && v15){
			v16 = e.options[e.selectedIndex].value;
			count++;
		}
		if(v17 && v18 && v19){
			v21 = e.options[e.selectedIndex].value;
			count++;
		}
		if(noofpass != count)
		{
