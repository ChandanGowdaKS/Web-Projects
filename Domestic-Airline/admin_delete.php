		...
		<article class="col2 pad_left1">
			<div class="container">
				<div class="row">
				  ...
				  <div class="col-sm-9">
				   <p class="account" style="color:white;">Enter the flight number to be deleted</p>
					<div>
						 
                         	<form action="" method="POST">
							<input id="flightno" type="text" name="flightno" placeholder="Flight no"/>							
							<a href="" class="button2" style="margin-right:740px;margin-top:67px;margin-bottom:15px" onClick="run()">Confirm</a>
							</form>
					</div>	
				  </div>
            </div>
