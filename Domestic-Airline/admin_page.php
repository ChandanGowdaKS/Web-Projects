...
$.ajax({
		...
		newdeparture: newdeparture, newarrival: newarrival, newfare: newfare, newdate: newdate, seats: seats },
		...
		<article class="col2 pad_left1">
			<div class="container">
				<div class="row">
				  ...
				  <div class="col-sm-9">
				   <p class="account" style="color:white;">New Flight Details</p>
					<div>
							...
							<input id="seats" type="text" name="seats" placeholder="No. of Seats"/>
							
							<a href="" class="button2" style="margin-top:47px;margin-bottom:15px;margin-right:60px;" onClick="run()">Confirm</a>
							</form>
					</div>	
				  </div>
            </div>
